# Django settings for ZimityPython project.
...
SECRET_KEY = '^249gt5ib)_i1wr%bpi@k51=8kw4-8s4#=q4fzb8ul_gj#a$h$'
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    #"zimity.templatetags.evaluate.context_processor",
)
